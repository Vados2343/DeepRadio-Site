export class PlayerStateMachine {
  constructor(options = {}) {
    ...
    this.transitions = {
      ...
      LOADING: { LOADED: 'LOADED', READY: 'READY', PLAY: 'PLAYING', BUFFERING: 'BUFFERING', ERROR: 'ERROR', SWITCH: 'SWITCHING' },
      LOADED: { BUFFERING: 'BUFFERING', PLAY: 'PLAYING', ERROR: 'ERROR', SWITCH: 'SWITCHING' },
      BUFFERING: { READY: 'READY', PLAY: 'PLAYING', ERROR: 'ERROR', PAUSE: 'PAUSED', SWITCH: 'SWITCHING' },
